...
public class CraftFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Button b = (Button) root.findViewById(R.id.plus);
        b.setOnClickListener(this);
        Button c = (Button) root.findViewById(R.id.minus);
        c.setOnClickListener(this);
        mProgressBar = (ProgressBar) root.findViewById(R.id.heatBar);
